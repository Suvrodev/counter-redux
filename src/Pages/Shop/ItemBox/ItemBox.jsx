...
const ItemBox = ({ product }) => {
  ...
  return (
    <div className="bg-white border border-[#95a0a7] w-full md:w-[250px] lg:w-[270px] h-[480px] rounded-lg relative">
      <img
      ...
      <div className="ml-4">
        ...
        <div className="text-[12px] font-lato font-normal tracking-[0.05px] mt-1">
          <Rating value={ratings} className="rt" />
        </div>
      </div>
      <button className="absolute bottom-0 w-full bg-orange-400 hover:bg-[#ff4500] text-white p-3 flex items-center justify-center gap-2 rounded-b-lg">
